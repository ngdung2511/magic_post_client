  ...
  useEffect(() => {
    const fetchOrderGather = async () => {
      const res = await getOrderByCondition({
        condition: { current_department: department._id },
      });
      const res2 = await getOrderByCondition({
        condition: { next_department: department._id },
      });
    ...
    const fetchOrderTrans = async () => {
      const res = await getOrderByCondition({
        condition: { send_department: department._id },
      });
      const res2 = await getOrderByCondition({
        condition: { receive_department: department._id },
      });
